package org.jily.hongbao.utils;
...
public class UpdateTask extends AsyncTask<String, String, String> {
    ...
    public static final String updateUrl = "https://api.github.com/jilyjiang/WeChatLuckyMoney/releases/latest";
